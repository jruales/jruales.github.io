...
basics = {
    ...
    + "<p>In addition to taking two university courses, my last school semester before graduation I was a TA for <a target=\"_blank\" href=\"http://www1.cs.columbia.edu/~allen/F15/\">Computational Aspects of Robotics</a> and I researched on using <a target='_blank' href='http://shapecompletiongrasping.cs.columbia.edu/'>Convolutional Neural Networks for robotic grasp planning</a>.</p>"
    + "<p>When not programming or playing with <a target=\"_blank\" href=\"https://www.desmos.com/calculator/hqgi7zssfd\">graphing calculators</a>, I am generally found bicycling, taking <a target='_blank' href='https://www.flickr.com/photos/46440167@N02/albums'>photos</a>, or <a target='_blank' href='https://github.com/jruales/Reading-List/blob/master/2018/README.md'>reading</a>.</p>",
